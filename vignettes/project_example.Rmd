...
native SummarizedExperiment constructor objects using 
...
```{r}
data <- SummarizedExperiment(assays = data$assay, 
...
```{r}
names(assays(base))[[1]] <- "abundances"                             
rf_results <- fit_rf(base, y = "Group", assay.type = "abundances")
